...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_xml_metadata_driver'] ?? $container->load('getDoctrine_Orm_DefaultXmlMetadataDriverService')), 'Gesdinet\\JWTRefreshTokenBundle\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\BetsRepository' => ['privates', 'App\\Repository\\BetsRepository', 'getBetsRepositoryService', true],
            'App\\Repository\\MatchsRepository' => ['privates', 'App\\Repository\\MatchsRepository', 'getMatchsRepositoryService', true],
            'App\\Repository\\TempLeaguesRepository' => ['privates', 'App\\Repository\\TempLeaguesRepository', 'getTempLeaguesRepositoryService', true],
            'App\\Repository\\TempMatchRepository' => ['privates', 'App\\Repository\\TempMatchRepository', 'getTempMatchRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\BetsRepository' => '?',
            'App\\Repository\\MatchsRepository' => '?',
            'App\\Repository\\TempLeaguesRepository' => '?',
            'App\\Repository\\TempMatchRepository' => '?',

...
class LexikJwtAuthenticationConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     */
    public function apiPlatform(mixed $value = []): \Symfony\Config\LexikJwtAuthentication\ApiPlatformConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function accessTokenIssuance(mixed $value = []): \Symfony\Config\LexikJwtAuthentication\AccessTokenIssuanceConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function accessTokenVerification(mixed $value = []): \Symfony\Config\LexikJwtAuthentication\AccessTokenVerificationConfig|static
    {
        if (!\is_array($value)) {
